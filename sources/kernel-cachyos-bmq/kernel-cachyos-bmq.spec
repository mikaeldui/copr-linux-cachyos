...
Source1:        https://raw.githubusercontent.com/CachyOS/linux-cachyos/master/linux-cachyos-bmq/config
...
Patch1:         %{_patch_src}/sched/0001-prjc-cachy.patch
...
%autopatch -p1 -v -M 9
    ...
    scripts/config -e CACHY -e SCHED_BMQ
